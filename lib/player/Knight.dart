...
class Knight extends Player {
  ...
  Knight(this.screenSize, {this.die, this.changeLife}) : super(life: 100);

  factory Knight.mainPlayer(Size screenSize,
      {double initX = 0.0, double initY = 0.0, Function(double) changeLife}) {
    return Knight(screenSize, changeLife: changeLife)
      ..position = Rect.fromLTWH(
          initX - sizePlayer, initY - sizePlayer, sizePlayer, sizePlayer)
      ..animation = FlameAnimation.Animation.sequenced("knight_idle.png", 6,
  ...
  void _runPlayerAniamation({bool left = false}) {
    if (!playerIsRun) {
      ...
      animation = FlameAnimation.Animation.sequenced(
          left ? "knight_run_left.png" : "knight_run.png", 6,
          textureWidth: 16, textureHeight: 16);
    }
  }
